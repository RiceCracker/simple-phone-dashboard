...
A simple flask based REST-ful API and dashboard to display common phone data crawled from phone web interfaces on a web frontend.
...
## On retrieving the data using the REST-ful API
